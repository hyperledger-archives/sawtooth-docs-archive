...
**Contents**
  ...
  - [Does Sawtooth restore state when a peer restarts or when a peer is out-of-sync with the network?](#does-sawtooth-restore-state-when-a-peer-restarts-or-when-a-peer-is-out-of-sync-with-the-network)
